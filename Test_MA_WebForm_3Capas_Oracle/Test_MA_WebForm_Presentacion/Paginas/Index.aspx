<%@ Page Title="" Language="C#" MasterPageFile="~/MA.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Test_MA_WebForm_Presentacion.Paginas.Index" %>
    ...
    <form runat ="server">
        ...
        <div class="container row">
            <div class="table small">
                <asp:GridView runat="server" ID="gvClientes" class="table table-borderless table-hover">
                    <Columns>
